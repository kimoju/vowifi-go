...
import (
	...
	"github.com/kimoju/vowifi-go/engine/swu"
...
// NotifySMSMemoryAvailable emits RP-SMMA control signalling through the
// active IMS transport. It never sends user-visible SMS content.
