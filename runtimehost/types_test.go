...
func TestDefaultTunnelManagerForStartEnablesTUNRoutingProtection(t *testing.T) {
	...
	if tunManager.Config.DefaultRoutes || !tunManager.Config.IsolateHostRouting || !tunManager.Config.ProtectEPDGRoutes {
		t.Fatalf("routing flags default/isolate/protect = %t/%t/%t", tunManager.Config.DefaultRoutes, tunManager.Config.IsolateHostRouting, tunManager.Config.ProtectEPDGRoutes)
	}
