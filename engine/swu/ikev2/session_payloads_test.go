...
func TestSWuConfigurationRequestMarshalParse(t *testing.T) {
	...
	if parsed.Type != CFGRequest || len(parsed.Attributes) != 6 || parsed.Attributes[2].Type != ConfigInternalIPv6Address || parsed.Attributes[4].Type != ConfigPCSCFIPv4Address || parsed.Attributes[5].Type != ConfigPCSCFIPv6Address {
